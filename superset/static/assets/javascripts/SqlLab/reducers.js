...
export const sqlLabReducer = function (state, action) {
  const actionHandlers = {
    ...
    [actions.SAVE_QUERY_CLEAR_ERROR]() {
    ...
    [actions.QUERY_SUCCESS]() {
      ...
      return {
        ...alterInObject(state, 'queries', action.query, alts),
        queryPageOffset: action.pageOffset ? action.pageOffset : 0,
        queryTotalCount: action.results.total_count,
      };
    },
