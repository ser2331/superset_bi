...
class UtilsTestCase(unittest.TestCase):
    def test_json_int_dttm_ser(self):
        ...
        assert json_int_dttm_ser(dttm) == '2020-01-01 03:00:00'
        assert json_int_dttm_ser(date(2020, 1, 1)) == '2020-01-01'
        assert json_int_dttm_ser(datetime(1970, 1, 1)) == '1970-01-01 03:00:00'
        assert json_int_dttm_ser(date(1970, 1, 1)) == '1970-01-01'
