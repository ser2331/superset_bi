...
* Установить `pip3 install mock` в контейнере superset, если ранее не был установлен
* Выполнить `docker-compose exec superset bash -c "cd .. && python -m unittest discover -s tests -p '*_tests.py'"`
