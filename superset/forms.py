...
class CsvToDatabaseForm(DynamicForm):
    ...
    csv_file = FileField(
        _('CSV File'),
        description=_('Select a CSV file to be uploaded to a database. Column names should contain only numbers, latin letters and underscore. Column names should not begin with number.'),
        validators=[
