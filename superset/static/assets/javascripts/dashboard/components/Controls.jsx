...
import { TYPE_CONVERT_DASHBOARD } from '../../explore/exportPDF';
...
function ActionMenuItem(props) {
  ...
  return (
    <MenuItem onClick={!disabled ? props.onClick : null} disabled={disabled}>
...
class Controls extends React.PureComponent {
  ...
  render() {
    ...
    const { can_edit: canEdit } = dashboard || {};
    return (
      <span>
        <DropdownButton
          title={t('Actions')}
        ...
        >
          ...
          {!editMode && (
            <ActionMenuItem
              disabled={!allSliceLoaded || exportedPdf}
              text={t('Export PDF')}
              tooltip={t('Export PDF')}
              faIcon='file-pdf-o'
              onClick={() =>
                exportToPDF(document.documentElement, TYPE_CONVERT_DASHBOARD)
              }
            />
          )}
        </DropdownButton>
