...
class TableVizTestCase(unittest.TestCase):
    ...
    @unittest.skip("Disabled exception raises")
...
class RoseVisTestCase(unittest.TestCase):
    ...
    def test_rose_vis_get_data(self):
        ...
        expected = {
            '2000-01-01 02:00:00': [{'key': ('a1',), 'value': 1, 'name': ('a1',), 'time': '2000-01-01 02:00:00'},
                                    {'key': ('b1',), 'value': 4, 'name': ('b1',), 'time': '2000-01-01 02:00:00'},
                                    {'key': ('c1',), 'value': 7, 'name': ('c1',), 'time': '2000-01-01 02:00:00'}],
            '2002-01-01 02:00:00': [{'key': ('a1',), 'value': 2, 'name': ('a1',), 'time': '2002-01-01 02:00:00'},
                                    {'key': ('b1',), 'value': 5, 'name': ('b1',), 'time': '2002-01-01 02:00:00'},
                                    {'key': ('c1',), 'value': 8, 'name': ('c1',), 'time': '2002-01-01 02:00:00'}],
            '2004-01-01 02:00:00': [{'key': ('a1',), 'value': 3, 'name': ('a1',), 'time': '2004-01-01 02:00:00'},
                                    {'key': ('b1',), 'value': 6, 'name': ('b1',), 'time': '2004-01-01 02:00:00'},
                                    {'key': ('c1',), 'value': 9, 'name': ('c1',), 'time': '2004-01-01 02:00:00'}]}
