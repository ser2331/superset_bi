...
import { DropdownButton, MenuItem, Tab, Tabs, Modal } from 'react-bootstrap';
...
class TabbedSqlEditors extends React.PureComponent {
  ...
  render() {
    const editors = this.props.queryEditors.map((qe, i) => {
      const activeQueryEditor = this.activeQueryEditor();
      const isSelected = activeQueryEditor && (qe.id === activeQueryEditor.id);
        ...
        >
          <div className="panel panel-default">
            <div className="panel-body">
              {isSelected &&
                <SqlEditor
                  toggleLeftBar={this.toggleLeftBar.bind(this)}
    ...
    return (
      <div>
        { this.props.saveError &&
          <Modal show onHide={this.clearError.bind(this)}>
            <Modal.Header closeButton>
              <Modal.Title>{t('Error')}</Modal.Title>
            </Modal.Header>
            <Modal.Body>
              <span className="tabbed-error-msg">
                { this.props.saveError.message}
              </span>
              <ul className="tabbed-error-details">
                { this.props.saveError.details && this.props.saveError.details
                .map((detail, index) => (
                  <li key={index} className="tabbed-error-detail">
                    {detail}
                  </li>
                ))}
              </ul>
