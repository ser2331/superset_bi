    ...
    return (
      <ButtonGroup className="ws-el-controls pull-right">
        ...
        {this.state.sortColumns ? (
          <Link
            className="fa fa-sort-numeric-asc pull-left sort-cols m-l-2"
            onClick={this.toggleSortColumns.bind(this)}
            tooltip={t('Original table column order')}
            href="#"
          />
        ) : (
          <Link
            className="sort-a-z pull-left sort-cols m-l-2"
            onClick={this.toggleSortColumns.bind(this)}
            tooltip={t('Sort columns alphabetically')}
            href="#"
          >
            <span className="arrow">🡓</span>
            <span className="letters">
              <span>{t('Sort a-z from')}</span>
              <span>{t('Sort a-z to')}</span>
            </span>
          </Link>
        )}
