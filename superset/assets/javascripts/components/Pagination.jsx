...
export default class Pagination extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    const pageChanged = prevProps.pageLength !== this.props.pageLength
      || prevProps.pageOffset !== this.props.pageOffset;
    if (this.container && pageChanged) {
        const height = this.getHeight(this.container.firstChild);
        this.props.onHeightChange(height);
    }
  }
  ...
  getHeight(ul) {
    const height = Number.parseInt(window.getComputedStyle(ul).height, 10) || 50;
    const marginTop = Number.parseInt(window.getComputedStyle(ul)['margin-top'], 10) || 20;
    const marginBottom = Number.parseInt(window.getComputedStyle(ul)['margin-bottom'], 10) || 20;
  ...
  render() {
    ...
    const pages = Math.ceil(this.props.total / this.props.pageLength);
    const selectedPage = Math.floor(((this.props.pageOffset || 0) / this.props.pageLength)) + 1;
