...
SUPERSET_WEBSERVER_TIMEOUT = 180  # deprecated
...
# Your App secret key
SECRET_KEY = 'JKLFD&*shd&D%DFgu8F^tdlkd'  # noqa
...
YANDEX_MAP_ICON_PATH = '/static/report_icons/'
...
class CeleryConfig(object):
    ...
    CELERY_ANNOTATIONS = {
        'sql_lab.get_sql_results': {
            'rate_limit': '100/s',
            'soft_time_limit': SQLLAB_ASYNC_TIME_LIMIT_SEC,
        },
    }


UPDATE_PENDING_QUERIES_TIME_SECONDS = int(os.environ.get('UPDATE_PENDING_QUERIES_TIME_SECONDS', 30*60))
...
# путь до исполняемого файла google chrome, вида `/usr/bin/google-chrome-stable`
PATH_TO_CHROME_EXE = ''
# полный url до api для рендера pdf, вида `https://url-to-pdf-api.herokuapp.com/api/render/`
URL_TO_RENDER_PDF = os.environ.get('URL_TO_RENDER_PDF','')
