...
export default class AdhocMetricEditPopover extends React.Component {
  ...
  render() {
    ...
    const aggregateSelectProps = {
      placeholder: tn('%s aggregates(s)', '%s aggregates(s)', Object.keys(AGGREGATES).length),
    ...
    return (
      ...
      >
        <FormGroup>
          <ControlLabel><strong>{t('Column')}</strong></ControlLabel>
          <OnPasteSelect {...this.selectProps} {...columnSelectProps} />
        </FormGroup>
        <FormGroup>
          <ControlLabel><strong>{t('Aggregate')}</strong></ControlLabel>
