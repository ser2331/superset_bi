...
import { FormControl, FormGroup, Row, Col, Checkbox } from 'react-bootstrap';
...
class SaveQuery extends React.PureComponent {
  constructor(props) {
    ...
    this.onIAMChange = this.onIAMChange.bind(this);
  }
  onSave() {
    const query = {
  ...
  onIAMChange(e){
    this.setState({ for_iam: e.target.checked });
  }
  toggleSave(e) {
      ...
      <FormGroup bsSize="small">
        ...
        <Row>
          <Col md={12}>
            <FormGroup>
              <Checkbox
                checked={this.state.for_iam}
                onChange={this.onIAMChange}
              >
                {t('For IAM')}
              </Checkbox>
            </FormGroup>
