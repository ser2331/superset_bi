...
class Chart extends React.PureComponent {
  ...
  height() {
    return (this.props.height || this.container.el.offsetHeight) - (this.paginationHeight || 0);
  }
  ...
  handlePagination(formData) {
      this.props.actions.runQuery(formData, false, this.props.timeout, this.props.chartKey);
  }
