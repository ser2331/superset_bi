...
export const ResultPanelDeltaSize = 91;
...
const propTypes = {
  ...
  onResizeResultPanel: PropTypes.func,
};
const defaultProps = {
  search: true,
  visualize: true,
...
export default class ResultSet extends React.PureComponent {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.height &&
        this.ResizableContainer &&
        this.ResizableContainer.state &&
        parseInt(this.ResizableContainer.state.height) - ResultPanelDeltaSize < parseInt(nextProps.height)
    ) {
      this.ResizableContainer.updateSize({ height: 'auto' });
    }
  }
  getControls() {
        ...
        return (
          <div>
            ...
            <Resizable
                ...
                enable={{ bottom: true }}
                onResize={this.props.onResizeResultPanel}
                style={{ paddingBottom: '10px' }}
                minHeight={150}
                ref={(ref) => { this.ResizableContainer = ref; }}
            >
              <FilterableTable
                  data={data}
