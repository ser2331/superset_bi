...
export const visTypes = {
    ...
    controlPanelSections: [
      {
        label: t("Query"),
        expanded: true,
        controlSetRows: [["geojson", "row_limit"]],
      },
      {
        label: t("Map"),
        controlSetRows: [
    ...
    controlPanelSections: [
      {
        label: t("Query"),
        expanded: true,
        controlSetRows: [["spatial", "row_limit"]],
      },
      {
        label: t("Map"),
        expanded: true,
  ...
  table: {
    ...
    controlPanelSections: [
      ...
      {
        label: t("Limits and Orders"),
        expanded: true,
        controlSetRows: [["order_by_metric"], ["row_limit", "page_length"]],
      },
      {
        label: t("Options"),
        expanded: true,
  ...
  pivot_table: {
    ...
    controlPanelSections: [
      ...
      },
      {
        ...
        controlSetRows: [
          ["sub_totals_by_rows", "rows_sub_totals"],
          ["sub_totals_by_columns", "column_sub_totals"],
          ["sub_totals_metrics"],
          ["totals_agg_funcs", "pivot_margins"],
      ...
      },
      {
        label: t('Conditional formatting'),
        expanded: true,
        controlSetRows: [['conditional_formatting_percentage'],['conditional_formatting']],
      },
    ],
    controlOverrides: {
  ...
  yandex_heat_map: {
    label: t("HeatMap, Yandex.Map"),
    controlPanelSections: [
      {
        label: t("Time"),
        expanded: true,
        description: t("Time related form attributes"),
        controlSetRows: [["granularity_sqla_single", "time_grain_sqla"], ["since", "until"]],
      },
      {
        label: t("Query"),
        expanded: true,
      ...
      {
        label: "Параметры тепловой карты",
        expanded: true,
        controlSetRows: [
          [ 
            'opacity',
  ...
  directed_force: {
    ...
    controlPanelSections: [
      ...
      {
        label: t("Options"),
        controlSetRows: [["link_length"], ["charge"], ["date_time_format"]],
      },
    ],
    controlOverrides: {
      groupby: {
    ...
    controlPanelSections: [
      {
        label: t("Query"),
        expanded: true,
        controlSetRows: [["entity"], ["country_fieldtype"], ["metric"]],
      },
      {
        label: t("Bubbles"),
        controlSetRows: [
  ...
  speedometer: {
    ...
    controlPanelSections: [
      ...
      },
      {
        ...
        expanded: true,
        controlSetRows: [
          ["speedometer_label", "speedometer_unit"],
          ["number_format"],
          ["show_legend"],
          ["labels_outside"],
        ],
      ...
      {
        label: t("Scale Speedometer"),
        expanded: true,
        controlSetRows: [['conditional_formatting_percentage'],['speedometer_sectors']],
      },
    ],
  },
}
...
export function sectionsToRender(vizType, datasourceType) {
  ...
  if (vizType === "bubble_map") {
    return [
      ...
      },
      {
        label: t("Bubble style"),
        expanded: true,
        controlSetRows: [["clustering"], ["autozoom"], ["zoom"]],
      },
      {
        label: t("Map"),
        expanded: true,
        controlSetRows: [["polygon_id"],['aggregation_by_area']],
      },
      {
        label: t("SQL"),
        controlSetRows: [["where"], ["having"]],
  ...
  const controlSetRowsForHeatMap = [
    ['datasource'],
    ['viz_type'],
    ['slice_id', 'cache_timeout'],
  ];
  ...
  return [].concat(
    !(vizType === 'yandex_heat_map')
      ? sections.datasourceAndVizType
      : {
          ...sections.datasourceAndVizType,
          controlSetRows: controlSetRowsForHeatMap,
        },
