...
class SouthPane extends React.PureComponent {
  ...
  render() {
    ...
    if (latestQuery) {
      results = (
        <ResultSet
          onResizeResultPanel={this.props.onResizeResultPanel}
          showControls
          search
          query={latestQuery}
          actions={props.actions}
          height={innerTabHeight}
          page={props.queryPage}
          pageLength={props.queryPageSize}
          pageOffset={props.queryPageOffset}
          total={props.queryTotalCount}
        />
      );
    } else {
...
function mapStateToProps(state) {
  return {
    ...
    queryPageSize: state.queryPageSize,
    queryPageOffset: state.queryPageOffset,
    queryTotalCount: state.queryTotalCount,
  };
}
